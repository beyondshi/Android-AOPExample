...
public class MainActivity extends Activity {
    ...
    private final View.OnClickListener btnRelativeLayoutOnClickListener = new View.OnClickListener() {
        @Override
    ...
    private final View.OnClickListener btnLinearLayoutOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
    ...
    private final View.OnClickListener btnFrameLayoutOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
